    ...
    <section class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url('images/background-impact.jpg')";
        background-position: center; background-repeat: no-repeat; background-size: cover; ">
                     ...
                     <div class="container-sm">
                        ...
                        <section id="produto">
                            <h2>O Produto</h2>
                            <p>Nosso chocolate de cacau orgânico é feito com ingredientes naturais e de alta qualidade, proporcionando um sabor delicioso e uma experiência única. Nosso chocolate de cacau orgânico é feito com ingredientes naturais e de alta qualidade, proporcionando um sabor delicioso e uma experiência única.</p>
                            <div class="image-container">
                                <img src="chocolate.jpg" alt="Imagem : Chocolate de cacau orgânico">
                            </div>
                        </section>
