...
@section('content')
    ...
    <section class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url('images/onde-tem-background.png')" ;
    ...
    <div class="container-sm">
        ...
        <section id="produto">
            ...
            <div class="image-container">
                <img src="/images/img-07.png" class="img-fluid rounded mx-auto d-block w-50" alt="Fruta de cacau">
            </div>
        </section>
